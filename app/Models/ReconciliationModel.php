<?php
	...
	class ReconciliationModel extends \CodeIgniter\Model
	{
		...
		protected $allowedFields = ['re_id', 're_staff_id', 're_type', 're_narration', 're_source', 're_destination',
			're_amount', 're_dctype', 're_transaction_date', 're_by', 're_date', 're_verify_by',  're_verify_date', 're_verify_comment', 're_approved_comment', 're_approved_by', 're_approved_date',
