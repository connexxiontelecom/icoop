...
<div class="row clearfix">
					...
					<table class="table table-hover js-basic-example dataTable simpletable table-custom spacing5">
						...
						<?php $sn = 1; foreach ($rms as $rm): ?>
							<tr>
								...
								<td>
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#ApproveModal<?=$rm['rm_id'] ?>"><i class="fa fa-check"></i></button>
	...
	<div class="col-sm-3">
		...
		<?php $sn = 1; foreach ($rms as $rm): ?>
			<div class="modal fade" id="ApproveModal<?=$rm['rm_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title h4" id="myLargeModalLabel">Approve Receipt</h5>
						...
						<div class="modal-body">
							<form method="post" action="">
								...
								<div class="row clearfix">
									<div class="col-lg-6 col-md-12">
										<div class="header">
											<p> <small><b>Verified By:</b> <?=$rm['rm_verify_by']; ?></small></p>
											<p><small><b>Verified Date:</b> <?=$rm['rm_verify_date']; ?></small></p>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-12">
										<div class="form-group">
											...
											<textarea   cols="30" rows="3" placeholder="Comments " disabled class="form-control no-resize"> <?=$rm['rm_verify_comment']; ?></textarea>
										</div>
									</div>
								
								</div>
								
								<input type="hidden" name="rm_status" value="2">
								
								<input type="hidden" name="rm_id" value="<?=$rm['rm_id']; ?>">
								
								<div class="form-group">
									<label for="application_address">Comment:</label>
									<textarea name="rm_approve_comment"   cols="30" rows="3" placeholder="Comments "  class="form-control no-resize"></textarea>
								</div>
