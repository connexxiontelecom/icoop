...
<div class="row clearfix">
					...
					<table class="table table-hover js-basic-example dataTable simpletable table-custom spacing5">
						...
						<?php $sn = 1; foreach ($jtms as $jtm): ?>
							<tr>
								...
								<td>
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifyModal<?=$jtm['jtm_id'] ?>"><i class="fa fa-check"></i></button>
	...
	<div class="col-sm-3">
		...
		<?php $sn = 1; foreach ($jtms as $jtm): ?>
			<div class="modal fade" id="verifyModal<?=$jtm['jtm_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title h4" id="myLargeModalLabel">Verify Journal Transfer</h5>
						...
						<div class="modal-body">
							<form method="post" action="">
								...
								<input type="hidden" name="jtm_status" value="1">
								
								<input type="hidden" name="jtm_id" value="<?=$jtm['jtm_id']; ?>">
								
								<div class="form-group">
									<label for="application_address">Comment:</label>
									<textarea name="jtm_verify_comment"   cols="30" rows="3" placeholder="Comments "  class="form-control no-resize"></textarea>
								</div>
		...
		<?php $sn = 1; foreach ($jtms as $jtm): ?>
			<div class="modal fade" id="deleteModal<?=$jtm['jtm_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title h4" id="myLargeModalLabel">Disqualify Journals</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">×</span>
							</button>
						</div>
