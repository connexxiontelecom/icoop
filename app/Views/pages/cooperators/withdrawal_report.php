...
<div class="row clearfix">
	<div class="col-lg-12">
		<div class="card">
			<div class="header">
				<h2>Withdrawal Report - View Report</h2>
		...
		<?php if(!empty($check)): ?>
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="header">
						<h2>Withdrawal Report for (<?=$ct_dt['contribution_type_name']; ?>) - </h2>
							...
							<?php  if(!empty($ledgers)): ?>
								<table class="table table-hover  table-custom spacing5 dataTable js-exportable">
									...
									<tr>
										...
										<th style="text-align: right"><strong>Charges</strong></th>
										...
										foreach ($ledgers as $ledger): ?>
											<tr>
												...
												<td style="text-align: right">
													...
													<?=number_format($ledger['withdraw_dr'], 2) ?>
														</td>
												<td style="text-align: right">
													
													<?=number_format($ledger['withdraw_charges_dr'], 2) ?>
