...
<div class="row clearfix">
	<div class="col-lg-12">
		<div class="card">
			<div class="header">
				<h2>Payroll Contribution Report - View Report</h2>
		...
		<?php if(!empty($check)): ?>
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="header">
						<h2>Payroll COntribution Report for (<?=$ct_dt['contribution_type_name']; ?>) - </h2>
										...
										foreach ($ledgers as $ledger): ?>
											<tr>
												...
												<td style="text-align: right">
													...
													<?=number_format($ledger['payroll_contribution_cr'], 2) ?>
														</td>
