                        ...
                        ?>
                         <tr role="row" class="odd">
                                <td class="sorting_1"  colspan="5">
                                    <strong style="font-size:16px; text-transform:uppercase;">Assets</strong>
                                </td>
                            </tr>
                            ...
                            <?php if($report->account_type == 2): ?>
                                  <tr role="row" class="odd">
                                    ...
                                    <td class="text-center"><?= (($bfDr + $report->sumDebit) - ($bfCr + $sumCredit)) < 0 ? number_format((($bfCr + $sumCredit) - ($bfDr + $sumDebit)),2) : 0 ?>
                                        <small style="display: none;">  <?= $aCPCrTotal += (($bfDr + $sumDebit) - ($bfCr + $sumCredit)) < 0 ? (($bfCr + $sumCredit) - ($bfDr + $sumDebit)) : 0 ?></small>
                                    </td>
                                </tr>
