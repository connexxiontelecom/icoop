...
<div class="row clearfix">
    ...
    <div class="col-sm-3">
        ...
        <?php $sn = 1; foreach ($withdrawals as $withdrawal): ?>
            <div class="modal fade bd-example-modal-lg" id="ApproveModal<?=$withdrawal['withdraw_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title h4" id="myLargeModalLabel">Approve Withdrawal</h5>
                        ...
                        <div class="modal-body">
                            <form method="post" action="">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="header">
                                            <p> <small><b>Verified By:</b> <?=$withdrawal['withdraw_verify_by']; ?></small></p>
                                            <p><small><b>Verified Date:</b> <?=$withdrawal['withdraw_verify_date']; ?></small></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea   cols="30" rows="3" placeholder="Comments " disabled class="form-control no-resize"> <?=$withdrawal['withdraw_verify_comment']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <textarea name="withdraw_approved_comment"   cols="30" rows="3" placeholder="Comments "  class="form-control no-resize"></textarea>
                                </div>
        ...
        <?php $sn = 1; foreach ($withdrawals as $withdrawal): ?>
            <div class="modal fade bd-example-modal-lg" id="deleteModal<?=$withdrawal['withdraw_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title h4" id="myLargeModalLabel">Disapprove Withdrawal</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="">
                                ...
                                <?= csrf_field() ?>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info btn-block">Disapprove</button>
                                </div>
                            </form>
                        </div>
                    </div>
