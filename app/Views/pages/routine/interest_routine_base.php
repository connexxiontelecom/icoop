					...
					<fieldset>
						<div class="row clearfix">
							<div class="col-lg-6 col-md-12">
								...
								<div class="form-group">
									<label for="ir_date"><b>Date:</b></label>
									<input type="date"  class="form-control" placeholder="Date" name="ir_date" value="<?=date('Y-m-d') ?>"  required>
								</div>
								
							
								<?= csrf_field() ?>
								<div class="form-group">
									<button type="submit" class="btn btn-info btn-block">Run Interest Routine</button>
								</div>
							</div>
