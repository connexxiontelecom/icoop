...
<div class="row clearfix">
	<div class="col-lg-12">
		<div class="card">
			<div class="header">
				<h2>Loan Repayment Exceptions</h2>
						...
						<div class="row clearfix">
							<div class="col-lg-6 col-md-12">
								<div class="form-group">
									...
									<label  for="application_payroll_group_id"> <b> Select Loan Type: </b></label>
									
									<select class="custom-select" required name="loan_type">
										
										<?php foreach ($loan_details as $loan_detail): ?>
											<option value="<?=$loan_detail['loan_setup_id'] ?>" > <?=$loan_detail['loan_description']; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<select class="custom-select" required name="year">
										...
										<?php foreach ($years as $year): ?>
											<option value="<?=$year['loan_exception_year'] ?>"> <?=$year['loan_exception_year']; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
									...
									<?php $sn = 1;
										...
										foreach ($exceptions as $exception): ?>
											<tr>
												...
												<td><?=$sn; ?></td>
												<td><?=$exception['loan_exception_staff_id']; ?></td>
