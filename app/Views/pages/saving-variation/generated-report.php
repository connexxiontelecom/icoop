			...
			<div class="body">
                <div class="row ">
                    ...
                    <div class="col-lg-12 col-md-12 col-xl-12 mt-5">
                        <p>
                            Saving variation report from <label for="" class="badge badge-info"><?= date('d-m-y', strtotime($from)) ?></label> to <label for="" class="badge badge-danger"><?= date('d-m-y', strtotime($to)) ?></label>
                        </p>
                    </div>
                </div>
