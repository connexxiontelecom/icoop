...
<?= $this->section('title') ?>
Verify Savings Reconciliations
<?= $this->endSection() ?>
...
<div class="row clearfix">
	<div class="col-lg-12">
		<div class="card">
			<div class="header">
				<h2>Verify Savings Reconciliations</h2>
					...
					<table class="table table-hover js-basic-example dataTable simpletable table-custom spacing5">
						...
						<?php $sn = 1; foreach ($reconciliations as $reconciliation): ?>
							<tr>
								...
								<td>
									<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifyModal<?=$reconciliation['re_id'] ?>"><i class="fa fa-check"></i></button>
	...
	<div class="col-sm-3">
		...
		<?php $sn = 1; foreach ($reconciliations as $reconciliation): ?>
			<div class="modal fade" id="verifyModal<?=$reconciliation['re_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title h4" id="myLargeModalLabel">Verify Reconciliation - <?php if($reconciliation['re_dctype'] == 2): echo 'Debit Transaction'; endif; if($reconciliation['re_dctype'] == 1): echo 'Credit Transaction'; endif; ?></h5>
						...
						<div class="modal-body">
							...
							<form method="post" action="">
								...
								<div class="row clearfix">
									<div class="col-lg-6 col-md-12">
										<div class="form-group">
											...
											<input class="form-control" value="<?=$reconciliation['contribution_type_name']; ?>" disabled readonly>
										</div>
									</div>
								...
								<input type="hidden" name="re_status" value="1">
								...
								<div class="form-group">
									<label for="application_address"><b>Verification Comment:</b></label>
									<textarea name="re_verify_comment"   cols="30" rows="3" placeholder="Verification Comments "  class="form-control no-resize"></textarea>
								</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form method="post" action="">
								...
								<?= csrf_field() ?>
								<div class="form-group">
									<button type="submit" class="btn btn-danger btn-block">Discard</button>
								</div>
							</form>
						</div>
					</div>
